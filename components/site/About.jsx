        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          <div className="lg:col-span-5">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: '-80px' }} transition={{ duration: 0.8 }}>
              ...
              <div className="mt-10 flex items-center gap-4 flex-wrap">
                <div className="inline-flex items-center gap-2 rounded-full glass-emerald px-4 py-2 text-[12px] font-medium text-emerald2-800">
          ...
          <div className="lg:col-span-7 relative">
            <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 0.9 }}
              className="relative h-[520px] rounded-[32px] overflow-hidden hairline">
              ...
              <div className="absolute inset-x-5 bottom-5 glass rounded-2xl p-5">
                <div className="flex items-end justify-between gap-4">
                  <div>
                    ...
                    <div className="mt-1 font-display text-2xl text-emerald2-900">Kerala · Tamil Nadu</div>
                    <div className="mt-1 text-xs text-slate-600">Direct partnerships · Fair pricing · Reduced post-harvest loss</div>
                  </div>
                  <div className="text-right">
                    <div className="font-display text-3xl gradient-emerald">500+</div>
