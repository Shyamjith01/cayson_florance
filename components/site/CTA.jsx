...
export default function CTA() {
  return (
    <section id="contact" className="relative py-12 sm:py-20 lg:py-24 mt-3 sm:mt-5 bg-white">
        ...
        <motion.div initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.9 }}
          ...
          <div className="relative grid lg:grid-cols-12 gap-6 sm:gap-10 items-end">
            <div className="lg:col-span-8">
              ...
              <h3 className="mt-4 sm:mt-6 font-display text-2xl sm:text-3xl lg:text-6xl tracking-[-0.02em] leading-[1.1] sm:leading-[1.02]">
            ...
            <div className="lg:col-span-4 flex flex-col gap-3">
              <Link href="/products" className="group inline-flex items-center justify-between gap-3 rounded-full bg-white text-emerald2-900 px-5 sm:px-7 py-3 sm:py-4 text-xs sm:text-sm font-medium shine hover:bg-emerald2-500 hover:text-white transition-all">
                <span>Explore Innovative Products</span>
                <ArrowUpRight className="h-4 w-4 group-hover:rotate-45 transition" />
              </Link>
              <a href="#about" className="group inline-flex items-center justify-between gap-3 rounded-full glass-dark border border-white/15 text-white px-5 sm:px-7 py-3 sm:py-4 text-xs sm:text-sm font-medium hover:border-white/40 transition-all">
