...
export default function Impact() {
  return (
    <section id="impact" className="relative  pt-10 pb-12 bg-gradient-to-b from-emerald2-50/40 via-white to-emerald2-50/30 overflow-hidden">
      <div className="absolute inset-0 dot-bg opacity-40" />
      <div className="relative mx-auto max-w-7xl px-6 mt-5">
